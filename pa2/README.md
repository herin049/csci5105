...
Clearly, we should expect that the system works with any number of nodes, including a single node. Running the program with the configuration file `configs/test_single.json` should display an output similar to the output below
